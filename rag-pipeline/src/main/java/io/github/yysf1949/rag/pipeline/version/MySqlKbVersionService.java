...
/**
 * MySQL dialect of {@link JdbcKbVersionService}. DDL uses {@code ENGINE=InnoDB}
 * and {@code utf8mb4} charset.
 */
public class MySqlKbVersionService extends JdbcKbVersionService {
    ...
    public MySqlKbVersionService(DataSource dataSource) {
        super(dataSource);
    }
